          ...
          <div className="flex items-center">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4 text-sm">
                <Link
                  href={isRu ? "/ru" : "/"}
                  className={`rounded-md px-3 py-2 font-medium nav-link ${
                    basePath === "/" || basePath === ""
                      ? "bg-blue-700 text-white"
                      : "text-gray-300 hover:bg-blue-700 hover:text-white"
                  }`}
                  aria-current={basePath === "/" || basePath === "" ? "page" : undefined}
                >
                  {isRu ? "Главная" : "Home"}
                </Link>
                <Link
          ...
          <div className="hidden md:flex gap-2 items-center">
            ...
            {isAuthenticated ? (
              <>
                <Link
                  href="/dashboard"
                  className="flex justify-center items-center border rounded border-[#303030] px-2 h-[37px] bg-zinc-950 text-white text-sm hover:bg-zinc-900"
                >
                  {user?.email}
                </Link>
                <button
