      ...
      <div className="flex justify-start flex-wrap mx-auto max-w-7xl">
        ...
        <div className="p-4 flex gap-4 mx-auto text-sm text-zinc-600 flex-wrap">
          <ul>
            ...
            <li className="mt-2">
              <Link href={isRu ? "/ru/public-offer" : "/public-offer"} className="text-zinc-600 hover:text-[#7a83f3]">
                {isRu ? "Публичная оферта" : "Public offer"}
              </Link>
            </li>
            <li>
              <Link href={isRu ? "/ru/privacy-policy" : "/privacy-policy"} className="text-zinc-600 hover:text-[#7a83f3]">
                {isRu ? "Политика конфиденциальности" : "Privacy policy"}
              </Link>
            </li>
            <li>
              <Link href={isRu ? "/ru/user-agreement" : "/user-agreement"} className="text-zinc-600 hover:text-[#7a83f3]">
