                ...
                <div className="grid grid-cols-4 gap-2">
                  ...
                  <div className="flex items-center justify-center p-2 bg-white/5 rounded-lg border border-white/10 hover:border-white/20 transition-all group">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <path d="M12 7L9 10.5L8 13L9 15.5L12 17L15 15.5L16 13L15 10.5L12 7Z" fill="white"/>
                      <path d="M12 7L12 10L10 11.5L10 14.5L12 15.5L14 14.5L14 11.5L12 10L12 7Z" fill="white"/>
                      <path d="M9 10.5L12 10L15 10.5" stroke="#FF001B" strokeWidth="0.5" strokeLinecap="round"/>
                      <path d="M9 15.5L12 15.5L15 15.5" stroke="#FF001B" strokeWidth="0.5" strokeLinecap="round"/>
                    </svg>
                  </div>
                  ...
                  <div className="flex items-center justify-center p-2 bg-white/5 rounded-lg border border-white/10 hover:border-white/20 transition-all group">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <path d="M12 8.5L12 13" stroke="white" strokeWidth="2.5" strokeLinecap="round"/>
                    </svg>
                  </div>
                </div>
              </div>
