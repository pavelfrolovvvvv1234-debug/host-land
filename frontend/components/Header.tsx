          ...
          <div className="flex items-center">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4 text-sm">
                <Link
                  href={isRu ? "/ru" : "/"}
                  className="rounded-md px-3 py-2 font-medium text-white transition-colors duration-300"
                  aria-current="page"
                >
                  {isRu ? "Главная" : "Home"}
                </Link>
                <Link
                  ...
                  className="rounded-md px-3 py-2 font-medium text-gray-300 hover:text-white transition-colors duration-300"
                >
        ...
        <div className="md:hidden">
          <div className="space-y-1 px-2 pb-3 pt-2 sm:px-3">
            <Link
              href={isRu ? "/ru" : "/"}
              onClick={closeMenu}
              className="block rounded-md px-3 py-2 text-base font-medium text-white transition-colors duration-300"
            >
              {isRu ? "Главная" : "Home"}
            </Link>
            <Link
              href={isRu ? "/ru/services" : "/services"}
              onClick={closeMenu}
              className="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:text-white transition-colors duration-300"
            >
              {isRu ? "Услуги" : "Services"}
            </Link>
            <Link
