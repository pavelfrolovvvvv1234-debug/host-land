...
const faqs = [
  {
    ...
    answer:
      "Войдите в личный кабинет на my.dior.host, перейдите в настройки API и создайте новый API ключ. Храните его в безопасности и никогда не публикуйте публично."
  },
  {
    ...
    <div>
      ...
      <section className="mt-8 bg-black/40 border border-white/10 rounded-xl p-6">
        ...
        <p className="text-white/70 text-sm mt-4">
          Получите ваш API ключ в личном кабинете: my.dior.host
        </p>
