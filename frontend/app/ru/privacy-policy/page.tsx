      ...
      >
        ...
        <section id="user-rights" className="mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-white/80 leading-relaxed mt-4">
              Для осуществления этих прав свяжитесь с нами по адресу <a href="mailto:support@dior.host" className="text-blue-300 hover:text-white underline">support@dior.host</a>. Мы ответим в течение 30 дней.
            </p>
          </div>
        </section>
