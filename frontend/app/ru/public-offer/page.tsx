      ...
      >
        <section id="general-provisions" className="mb-12">
          ...
          <p className="text-white/80 leading-relaxed mb-4">
            Настоящая Публичная оферта (далее — "Соглашение") представляет собой юридически обязывающий договор между Dior Host ("Провайдер", "мы", "нас") и любым физическим или юридическим лицом ("Клиент", "вы", "заказчик"), которое принимает эти условия, используя наши услуги.
          </p>
          <p className="text-white/80 leading-relaxed mb-4">
            Получая доступ, регистрируясь или используя любую услугу, предоставляемую Dior Host, вы подтверждаете, что прочитали, поняли и согласны быть связанными этим Соглашением. Если вы не согласны с этими условиями, вы не должны использовать наши услуги.
          </p>
          <p className="text-white/80 leading-relaxed">
            Это Соглашение вступает в силу немедленно после принятия и остается в силе до расторжения любой из сторон в соответствии с условиями, изложенными здесь.
          </p>
        </section>
        ...
        <section id="definitions" className="mb-12">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-white/80 leading-relaxed">
                Любая хостинговая, инфраструктурная или связанная услуга, предоставляемая Dior Host, включая, но не ограничиваясь: VPS, VDS, выделенные серверы, услуги IPHM, регистрация доменов и веб-хостинг.
              </p>
            </div>
            <div>
        ...
        <section id="services" className="mb-12">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-white/80 leading-relaxed">
                Общие и управляемые хостинг-услуги с гибкой политикой обработки жалоб, подходящие для высокорисковых рабочих нагрузок.
              </p>
            </div>
          </div>
        </section>
