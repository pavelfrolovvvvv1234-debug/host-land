...
const hero = {
  ...
  summary:
    "Проще говоря, абузоустойчивый веб-хостинг — это управляемый стек, который продолжает работать даже при жалобах и DMCA, благодаря офшорным площадкам в Нидерландах, США, Германии и Турции."
};
...
const sections = [
  ...
  },
  {
    ...
    body: "Кластеры в Нидерландах, США, Германии и Турции с Anycast-маршрутизацией.",
    bullets: [
