      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="relative rounded-2xl border border-white/5 bg-surface/50 p-8 sm:p-20 shadow-2xl overflow-hidden backdrop-blur-sm mb-12">
          ...
          <div className="relative z-10 text-center">
            ...
            >
              Выберите идеальное хостинг-решение для ваших задач. От абузоустойчивых VDS до выделенных серверов — мы предлагаем широкий спектр услуг для поддержания ваших проектов в сети.
            </motion.p>
          </div>
        </div>
